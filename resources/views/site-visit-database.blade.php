...
.svd-title{font-size:28px;font-weight:700;color:white;margin:0 0 8px;position:relative;z-index:2}
...
<div class="svd-header">
    <div class="svd-content">
        <div class="svd-eyebrow">Site Visit Database</div>
        <h1 class="svd-title">Happy ArkCrest Morning, {{ auth()->user()->preferred_address ? auth()->user()->preferred_address.' '.auth()->user()->name : auth()->user()->name }}!</h1>
